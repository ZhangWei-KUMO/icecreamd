...
function animation() {
  ...
  tl.from('#bottomLeft', 0.5, { scaleY: 0, transformOrigin: "bottom", ease: Power2.easeOut })
    ...
    .from('#leftBc', 0.5, { scale: 0, transformOrigin: "center", ease: Circ.easeOut })
    .from('#left', 0.2, { scaleX: 0, transformOrigin: "center", ease: Circ.easeOut })
    .from('#rightBc', 0.5, { scale: 0, transformOrigin: "center", ease: Power2.easeOut })
      ...
      <div className="welcome-container">
        <svg id="Capa_1" enableBackground="new 0 0 512 512" height="512"
          ...
          <g>
            ...
            <path d="m400.092 511.999h-288.184v-15c0-54.639 44.452-99.092 99.092-99.092h90c54.64 0 99.092 44.453 99.092 99.092z" fill="#f9ecd7" id="bottomLeft" />
            <path d="m400.092 496.999c0-54.639-44.452-99.092-99.092-99.092h-45v114.092h144.092z" fill="#f5d7b0" id="bottomRight" />
            <path d="m61.031 190.005-61.031-60.003 61.031-60.003 374.469.003v120l-266.519.002-12.021-12.228-12.022 12.229z" fill="#f9b700" id="leftBc" />
            <path d="m256 70.001h179.5v120.001h-179.5z" fill="#f49d14" id="left" />
            <path d="m450.969 350.011-287.025-.002-12.021-12.227-12.02 12.226h-63.403v-120l266.519-.002 12.021 12.228 12.022-12.228 83.906-.001 61.032 60.003z" fill="#f9b700" id="rightBc" />
